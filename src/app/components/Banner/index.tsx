        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 space-x-1">
          <div className="col-span-6 flex flex-col justify-evenly">
            ...
            <h3 className="text-charcoal text-lg font-normal text-center lg:text-start opacity-75 pt-5 lg:pt-0">
              Be the best by learning from the best, elevate your career to new
              heights of success, paving the way for a brighter future.
            </h3>

            <div className="flex gap-3 flex-col sm:flex-row items-center justify-between pt-10 lg:pt-4">
