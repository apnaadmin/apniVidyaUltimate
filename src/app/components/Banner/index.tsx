...
</svg>                          <h3 className='text-kellygreen text-sm font-semibold text-center lg:text-start'>Get 30% off on first enroll</h3>
                        </div>
...
<path d="M27.5 5L15 17.5125L11.25 13.7625" stroke="#1CBEEE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <Link href="/ViewTeachers">
            <div className="mt-10 mb-10 py-10 sm:py-24" id="mentor"><div className="min-w-full h-6 flex justify-center items-center"><a className="lg:py-10 lg:px-16 lg:text-2xl bg-cornflowerblue text-xl text-white hover:bg-Blueviolet hover:shadow-2xl text-blue-700 font-semibold hover:text-white py-5 px-8 border border-blue-500 hover:border-transparent rounded-3xl" href="/ViewTeachers">View all teachers</a></div></div>
            </Link>
            <br></br>
        </div>
