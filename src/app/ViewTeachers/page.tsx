                  ...
                  <div className="bg-white m-3 px-3 pt-3 pb-2 my-20 shadow-courses rounded-2xl sm:grid sm:grid-cols-2 dark:bg-gray-300 ">
                    <div className="relative rounded-3xl">
                      <Image
                        ...
                        width={238}
                        height={12}
                        className=" mt-3 border-2 rounded-lg border-gray-500 dark:bg- "
                      />

                      <div className="absolute right-5 -bottom-2 bg-ultramarine rounded-full p-6"></div>
                    </div>

                    <div className="px-3">
                      <h4 className="text-2xl font-semibold pt-6 text-gray-700">
                        {item.name},
                      </h4>
                      <h4 className="text-lg  pt-1 text-gray-500">
                        {item.experience}
                      </h4>
