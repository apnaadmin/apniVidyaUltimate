      ...
      <Form {...form}>
        ...
        >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Provide your email address. Note that this will be publicly
                  visible on the website for students to contact you.
                </FormDescription>
                <FormMessage />
              </FormItem>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="Language Arts / English">
                    ...
                    <SelectItem value="Home Economics / Family and Consumer Sciences">
                      Home Economics / Family and Consumer Sciences
                    </SelectItem>
                    <SelectItem value="Philosophy / Ethics">
                      Philosophy / Ethics
                    </SelectItem>
                    ...
                    <SelectItem value="Counseling / Guidance">
                      Counseling / Guidance
                    </SelectItem>
                    <SelectItem value="Business Education">
                      Business Education
                    </SelectItem>
                    <SelectItem value="Media Studies / Communication">
                    ...
                    <SelectItem value="Cultural Studies">
                      Cultural Studies
                    </SelectItem>
          ...
          <p className="font-bold text-black dark:text-white">
            Please make sure you did not left any field empty before paying the
            fee
          </p>
          <Button
            className="z-50 bg-yellow-500 ml-2 mr-6 "
            type="button"
            onClick={makePayment}
          >
            Pay Rs.49{" "}
          ...
          <Button
            disabled={isLoading || !isAuthentic}
            type="submit"
